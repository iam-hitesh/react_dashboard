                    ...
                    <div className="navbar-header">
                        <a href="#/" className="navbar-brand">
                            <div className="brand-logo">
                                <img src="img/logo1.png" alt="App Logo" className="img-responsive" />
                            </div>
                    ...
                    <div className="nav-wrapper">
                        ...
                        <ul className="nav navbar-nav navbar-right">
                            <li className="select_option">
                                <select className="form-group has-feedback">
                                    <option type="text" className="form-control">English</option>
                                    <option type="text" className="form-control">Spanish</option>
                                    <option type="text" className="form-control">French</option>
                                    <option type="text" className="form-control">New</option>
                                </select>
                            </li>
